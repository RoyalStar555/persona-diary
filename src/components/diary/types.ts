...
export const INITIAL_ENTRIES: Entry[] = [
  { id: "1", day: "14", mon: "Jun", title: "A quiet Sunday morning", preview: "The coffee was warm and the sunlight came through the curtains in that perfect golden angle. I felt immensely grateful for small joys and quiet mornings.", body: "The coffee was warm and the sunlight came through the curtains in that perfect golden angle. I sat there just breathing it all in, feeling immensely grateful for small joys and quiet mornings. There is something sacred about Sunday stillness.", mood: "😊 Happy", moodBg: "#FAEEDA", moodColor: "#412402", moodBdr: "#FAC775", cats: ["Personal"], catBg: "#EAF3DE", catColor: "#173404" },
  { id: "2", day: "13", mon: "Jun", title: "Project milestone achieved 🎉", preview: "We finally shipped the feature! The team celebrated and I felt this overwhelming sense of pride and relief wash over me.", body: "We finally shipped the feature after three weeks of late nights. The team had cake. I felt this wave of pride and relief that I have not felt in a while.", mood: "🤩 Excited", moodBg: "#EEEDFE", moodColor: "#26215C", moodBdr: "#CECBF6", cats: ["Work"], catBg: "#F1EFE8", catColor: "#2C2C2A" },
  ...
  { id: "4", day: "10", mon: "Jun", title: "A walk by the river", preview: "Took an hour off and walked along the riverbank. Two kids throwing stones reminded me of being eight years old.", body: "Took a full hour off and just walked along the riverbank. The geese were out. Two kids throwing flat stones. Reminded me of being eight years old with my dad.", mood: "🌿 Calm", moodBg: "#EAF3DE", moodColor: "#173404", moodBdr: "#C0DD97", cats: ["Travel", "Personal"], catBg: "#E6F1FB", catColor: "#042C53" },
  { id: "5", day: "08", mon: "Jun", title: "Missing home", preview: "Called mum today. Three months since I last saw her. Her laugh was clear as ever. Warm and hollow at the same time.", body: "Called mum today. Three months since I last saw her. The video call was pixelated but her laugh came through crystal clear.", mood: "💜 Grateful", moodBg: "#FBEAF0", moodColor: "#4B1528", moodBdr: "#F4C0D1", cats: ["Personal"], catBg: "#F1EFE8", catColor: "#2C2C2A" },
];

export type ViewId =
  | "dashboard" | "editor" | "entries" | "handwriting" | "calendar"
